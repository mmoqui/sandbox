...
<head>
  ...
  <title>silverpeas-opencmis Server</title>
  <style type="text/css">
  <!--
  body {
...
<h1>silverpeas-opencmis Server</h1>

<p style="font-weight: bold">Your server is up and running.</p>
<p>The silverpeas-opencmis server is a CMIS server based on Apache Chemistry OpenCMIS.</p>
